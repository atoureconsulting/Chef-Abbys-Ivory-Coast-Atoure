...
LINES = [
    ("Arrival & stay", "VIP airport welcome + fast-track (arrival & departure)", 200_000, 2, "Core", "In-kind: Ministry of Tourism protocol", ""),
    ...
    ("Ground team", "Bilingual fixer / on-camera interpreter (FR↔EN)", 80_000, f"={DAYS}", "Core", "Paid", ""),
